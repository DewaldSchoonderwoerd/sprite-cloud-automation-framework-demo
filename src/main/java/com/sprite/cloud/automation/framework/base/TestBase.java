        ...
        if (platformType.toUpperCase().equals(WEB)) {
            switch (browserName.toUpperCase()) {
                ...
                case CHROME_REMOTE:
                    ...
                    driver = new RemoteWebDriver(new URL("http://0.0.0.0:4444/wd/hub"), chromeRemoteOptions);
                    break;
                case FIREFOX_REMOTE:
                    FirefoxOptions firefoxRemoteOptions = new FirefoxOptions();
                    driver = new RemoteWebDriver(new URL("http://0.0.0.0:4444/wd/hub"), firefoxRemoteOptions);
                    break;
                default:
